...
import { Facebook, ChevronDown } from '@lendi-ui/icon';

## Usage

```
import MenuDropdown from '@lendi-ui/MenuDropdown';
```

```jsx
<MenuDropdown id="test" className="testClass">
  <MenuDropdown.Trigger iconBefore={<Facebook color="primary.500"/>} iconAfter={<ChevronDown color="primary.500"/>}>
    mail.com 
