...
<TextArea size="md" rows={3} maxRows={7} cols={80} placeholder="I'm a placeholder 🎉"/>
...
<PropTable>
  ...
  <PropTable.Entry name="maxRows" type="number" description="The maxrows textarea auto expand can be."/>
  <PropTable.Entry name="onBlur" type='() => void' description="Blur handler"/>
  <PropTable.Entry name="onChange" type='() => void' description="Change handler"/>
