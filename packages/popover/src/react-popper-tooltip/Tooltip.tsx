...
class Tooltip extends React.Component<TooltipProps> {
  ...
  public componentDidMount() {
    ...
    if (trigger !== 'none') {
      const { removeParentOutsideClickHandler, removeParentOutsideRightClickHandler } = this.context;
  ...
  public componentWillUnmount() {
    ...
    if (trigger !== 'none') {
      const { isParentNoneTriggered, addParentOutsideClickHandler, addParentOutsideRightClickHandler } = this.context;
  ...
  private addOutsideRightClickHandler = () =>
    document.body.addEventListener('contextmenu', this.handleOutsideRightClick!);

  private removeOutsideRightClickHandler = () =>
    document.body.removeEventListener('contextmenu', this.handleOutsideRightClick!);
