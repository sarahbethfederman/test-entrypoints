...
<PropTable>
  <PropTable.Entry name="className" type="string" description="Class to give to the ToggleSwitch"/>
  ...
  <PropTable.Entry name="isErrored" type="boolean" defaultValue={false} description="Whether ToggleSwitch is showing an error state."/>
