...
export interface DynamicMapState {
  map: google.maps.Map | {};
  size: number;
}

export default class DynamicMap extends React.Component<DynamicMapProps, DynamicMapState> {
  ...
  constructor(props: DynamicMapProps) {
    super(props);
  ...
  render() {
    ...
    return <MapWrapper ref={this.mapBox} size={this.state.size} showMap={this.props.showMap} />;
  }
}
