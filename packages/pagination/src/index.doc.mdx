...
```jsx
  ...
  <Pagination totalPages={10} currentPage={1} visiblePages={7} onChangePage={()=> {}} id="testId" aria-label="testLabel"/>
...
<PropTable>
  ...
  <PropTable.Entry name="onChangePage" type="(number) => void" description="Handle Chevron Icon button clicking event"/>
